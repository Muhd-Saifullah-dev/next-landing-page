    ...
    <section className="pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip ">
        <div className='container'>
            <div className='md:flex items-center'>
                ...
                <p className='text-xl tracking-tighter text-[#010D3E] mt-6'>
        ...
        <Image src={cog} alt='cog image' className='md:absolute md:h-full md:w-auto md:max-w-none md:-left-6 lg:left-0'/>
        <Image  src={cylinder} alt='cylinder image' height={220} width={220} 
